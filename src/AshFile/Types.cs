...
public enum AshFileTypeOld : byte{ //Represents the type of value in a AshFile field
	ByteArray = 0,
	String = 1,
	Byte = 2,
	Ushort = 3,
...
public enum AshFileType : byte{ //Represents the type of value in a AshFile field
	Default = 0,
	String = 1,
	Byte = 2,
	Ushort = 3,
